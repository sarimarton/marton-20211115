  ...
  return (
    <div className="relative">
      ...
      <div className={`relative z-10 flex pr-8 sm:px-8 ${props.className}`}>
        <div className="tabular-numbs w-1/3 text-right">{props.price}</div>
        <div className="tabular-numbs w-1/3 text-right">{props.size}</div>
        <div className="tabular-numbs w-1/3 text-right">{props.total}</div>
      </div>
    </div>
  )
}
